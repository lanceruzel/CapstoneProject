<x-modal-card name="affiliatePayoutHistoryModal" width='3xl' title="Payout History" align='center' x-on:close="$dispatch('clearaffiliatePayoutHistoryData')" x-cloak blurless wire:ignore.self>  
    <div class="flex flex-col gap-2 items-center justify-center text-gray-600 overflow-auto p-2">
        @if($payouts)
            <div>
                <div class="p-5 w-full flex flex-col items-center justify-center rounded-md">
