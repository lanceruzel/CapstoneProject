    ...
    <main class="w-screen h-screen">
        <div class="overflow-hidden h-full">
            <div class="relative flex items-center justify-center h-full w-full px-3 md:px-5 lg:px-10 z-60">
                <div class="flex max-w-[500px] flex-col items-center justify-center max-lg:mt-40 text-center bg-white p-10 rounded shadow">
                ...
                <x-button class="mt-3" label="Proceed >" href="{{ route('home') }}" />
