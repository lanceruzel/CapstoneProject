<x-modal-card name="payoutHistoryModal" width='3xl' title="Payout History" align='center' x-cloak x-on:close="$dispatch('clearPayoutHistoryModal')" blurless wire:ignore.self>  
